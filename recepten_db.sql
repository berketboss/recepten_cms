...
--
-- Host: 127.0.0.1
-- Gegenereerd op: 19 dec 2025 om 00:42
...
CREATE TABLE `recipes` (
  ...
  `description` text NOT NULL COMMENT 'Voor de ingrediënten/stappen',
  `category_id` int(11) NOT NULL COMMENT 'Koppelt aan de categories tabel'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
